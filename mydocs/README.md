...
| [hermes-传输层深度分析.md](hermes-传输层深度分析.md) | Hermes 传输层深度分析：薄 ABC 设计哲学、三层调用架构（helpers→transports→adapters）、provider_data 逃生舱模式、Duck-Typing 向后兼容、与 litellm/LangChain/Claude Code 对比 | 2026-06-23 |
